...
# data = pd.read_csv(r"Python Topic\data\2022年-各車廠總銷售量.csv", header=0, nrows=9, encoding="utf-8-sig")
...
#     # SQL 語法: 創建 資料表 及 欄位
#     sql1 = """CREATE TABLE IF NOT EXISTS e_moto_2022    (brand VARCHAR(20),
#                                                         sell int(10))"""
...
#         sql2 = """INSERT INTO e_moto_2022  (brand, sell)
#                                         VALUES(%s,%b)"""
...
try:
    ...
    # 設定標題
    plt.title("2022年-電動機車大眾品牌傾向", size = 20)
